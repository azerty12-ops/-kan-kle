...
async def auth_middleware(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Security: Prevent unauthorized access to the bot."""
    ...
    try:
        ...
        logger.error("Security misconfiguration: ALLOWED_USER_ID is not set or invalid.")
...
def main() -> None:
    ...
    # Authentication middleware (must run before everything else)
