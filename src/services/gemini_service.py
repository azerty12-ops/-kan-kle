...
class GeminiService:
    ...
    async def generate_response(self, prompt: str) -> str:
        ...
        try:
            # ⚡ Bolt Optimization: Using `generate_content_async` instead of synchronous `generate_content`.
            # This prevents a single LLM API call (which can take several seconds) from blocking
            # the entire asyncio event loop, thereby allowing the Telegram bot to handle
